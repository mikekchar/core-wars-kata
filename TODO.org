* Core Wars Kata
  Almost finished the DAT.F instruction.  It was less trouble
  than I imagined.  Hopefully things will go quickly from here.
  After this, I should probably spend some time looking at the
  design and see what I can do to clean it up.
...
**** Remove Warrior from warriors when it has no tasks
