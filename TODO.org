* Core Wars Kata
  Not too bad given that I had a conversation about socio-political
  topics while I was doing that.  Next time I should tackle the
  warriors (finally!).  Until then.
** Burndown
