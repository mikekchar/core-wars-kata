* Core Wars Kata
  Not really feeling well today, so I'm going to leave it at that.
  Failing tests are good.  I'm not super happy with all the delegation, etc
  so I need to think about the overall shape of the code at some point.
  Until next time!
** Burndown
*** Add Step command
