* Core Wars Kata
  Obviously error handling is a bit issue due to the not-so-nice
  way I'm doing recursive descent.  However, it's orthagonal to
  the creation of warriors, so I'm happy to back-burner it for a
