* Core Wars Kata
  Ha ha!  Impossible to program on the couch at Christmas eve
  when all others around you are drinking beer.  See you next time!
** Burndown
...
***** Display an empty list of warriors when e is pressed
      I'm not going for ^E as it is needlessly complicated for
      no actual benefit.
**** Add a warrior
