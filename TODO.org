* Core Wars Kata
  Passing nil into an argument is really questionable, but
  I'm going to leave it for now because it is very simple code.

  That's all for today.  This has been One Pomodoro a Day.
  Until next time!
** Burndown
*** Add Step command
