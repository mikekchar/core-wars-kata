* Core Wars Kata
  Because I haven't been working on this recently, I didn't
  really feel comfortable hitting the meat and potatoes of
  the functionality and instead just did some fiddly stuff.
  Next time I may do something interesting... who knows...
** Burndown
*** Inspect running state of the memory
*** TODO print address when outputting the memory
